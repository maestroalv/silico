...
\033[1;91m ╠═╝\033[1;90m├─┤│ ┬├┤  \033[1;91m ║ \033[1;90m├┤ ├┬┘││││ │┌┴┬┘
\033[1;91m ╩  \033[1;90m┴ ┴└─┘└─┘ \033[1;91m ╩ \033[1;90m└─┘┴└─┴ ┴└─┘┴ └─
\033[1;97m|\033[1;96m---------------------------------\033[1;97.|
 \033[47;1;91m        Coded by : LeON          \033[0m
	""")

def loading():
	for a in tqdm(range(150)):
		sleep(0.1)
		pass
...
class main:
	...
	\033[1;97m{\033[1;96m00\033[1;97m}\033[1;91m---\033[1;91mBack to main menu
		...
		if choose in ['1','01']:
			...
			input("\033[0mpress enter...");os.system('python hurt.py')
		else:
...
neofetch --ascii_distro kali
		...
		print("\033[0m setting theme.....");sleep(1);loading();print("\033[1;97m[\033[1;91m!\033[1;97m]\033[1;92m Finish!, Close u Termux and open again");sleep(2)
		input("\033[0mpress enter...");os.system('python hurt.py')
