...
class Main:
    ...
    \033[1;97m{\033[1;96m03\033[1;97m}\033[1;91m---\033[1;97mSMS Boomber for Indonesian Number Phone
		...
		while True:
			try:
				...
				if choose in ['1','01']:
					...
					sleep(1)
					os.system('python files/boom/sms.py')
					sys.exit()
				elif choose in ['0','00']:
					sleep(1)
					...
					sleep(1)
					os.system('python files/sc/deface.py')
				elif choose in ['5','05']:
					sleep(1)
					os.system('python files/deface/def.py')
				else:
					sleep(1)
